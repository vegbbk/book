...
- (void)initialize{
    ...
    self.scrollView.layer.shadowColor = [UIColor blackColor].CGColor;//阴影颜色
    self.scrollView.layer.shadowOffset = CGSizeMake(-2, -2);//偏移距离
    self.scrollView.layer.shadowOpacity = 0.7;//不透明度
    self.scrollView.layer.shadowRadius = 7;//半径
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    NSLog(@"ceshiyixa%f",scrollView.contentOffset.x / _pageSize.width);
